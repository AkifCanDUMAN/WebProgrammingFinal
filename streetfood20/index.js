...
function displayItems(){
    ...
    var hamburgers=  document.getElementById('hamburgers');
    ...
    const hamburgersData= foodItem.filter((item)=>item.category=='hamburgers');
    ...
    hamburgersData.map(item=>{
        ...
        hamburgers.appendChild(itemCard)
